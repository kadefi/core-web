...
import { getTradingPairs } from "../src/api/TradingPair.api";
import { useGetTradingPairs } from "../src/api/TradingPair.queries";
import DexScanLogo from "../src/assets/pngs/logos/dex-scan-logo.png";
import {
...
import { TradingPairInfoUtil } from "../src/utils";
    ...
    <div className="flex h-full flex-1 flex-col">
      <div className="flex-initial sm:px-6">
        <div className="mb-1 py-3 px-4 sm:px-0 md:py-4">
          <h1 className="mb-2 flex justify-between text-slate-300">
            <span
            ...
            <span className="flex items-center gap-2">
              ...
              <DropdownSelect options={["USD", "KDA"]} defaultOption="USD" />
            </span>
          </h1>
