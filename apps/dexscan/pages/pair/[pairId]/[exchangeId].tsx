...
import { ArrayUtil, DateUtil, NumberUtil } from "utils";

import { trackEvent } from "../../../src/analytics/Analytics.util";
import {
  getTradingPairInfo,
  getTradingPairs,
} from "../../../src/api/TradingPair.api";
import { useGetTradingPairInfo } from "../../../src/api/TradingPair.queries";
import { getTransactions } from "../../../src/api/Transaction.api";
import { useGetTransactions } from "../../../src/api/Transaction.queries";
import DiscordLogo from "../../../src/assets/svgs/socials/discord.svg";
import GithubLogo from "../../../src/assets/svgs/socials/github.svg";
import TelegramLogo from "../../../src/assets/svgs/socials/telegram.svg";
import TwitterLogo from "../../../src/assets/svgs/socials/twitter.svg";
import WebsiteLogo from "../../../src/assets/svgs/socials/website.svg";
import {
  PATH_FALLBACK,
...
import { AmplitudeEvent } from "../../../src/enums";
import { getPageLayout } from "../../../src/layouts/Layout";
import { TradingPairInfo } from "../../../src/types/TradingPairTable.type";
import { TransactionInfo } from "../../../src/types/TransactionsTable.type";
import { TradingPairInfoUtil, TransactionInfoUtil } from "../../../src/utils";

const TVChartContainer = dynamic(
  // @ts-ignore
  () =>
    import("../../../src/components/TVChartContainer").then(
  ...
  const tokenSwapMobile = (className?: string) => (
    ...
    >
      <div className="my-8 flex w-full items-center justify-center gap-2">
        <LogoImg alt="Token1 Logo" src={token1.img} size="lg" />
        <ArrowsUpDownIcon className="h-5 w-5 rotate-90 text-slate-400" />
        <LogoImg alt="Token0 Logo" src={token0.img} size="lg" />
      </div>
